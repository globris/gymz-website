...
const HeroSection = () => (
  ...
  >
    ...
    <div className="relative z-10 container mx-auto px-4 text-center py-32">
      ...
      <h1 className="font-display text-6xl sm:text-7xl md:text-8xl lg:text-9xl leading-none tracking-tight text-foreground mb-6 animate-fade-in-up [animation-delay:0.15s] opacity-0">
        FORGE YOUR<br />
