...
const transformations = [
  { image: transform1, name: "James K.", result: "Lost 35kg in 10 months", program: "Strength & Conditioning" },
  { image: transform2, name: "Lisa M.", result: "Complete body recomposition", program: "HIIT & Nutrition Plan" },
  { image: transform3, name: "Alex R.", result: "Gained 15kg of muscle", program: "Bodybuilding Program" },
];
